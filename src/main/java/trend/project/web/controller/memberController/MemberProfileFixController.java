...
public class MemberProfileFixController {
    ...
    // 회원 username 수정
    @Operation(description = "회원 username 수정 API")
    ...
    // 회원 비밀번호 수정
    @Operation(description = "회원 비밀번호 수정 수정 API")
    ...
    // 회원 이름 수정
    @Operation(description = "회원 이름 수정 API")
    @PatchMapping("/names")
    ...
    // 회원 휴대폰 번호 수정
    @Operation(description = "회원휴대폰 번호 수정 API")
    ...
    // 회원 이메일 수정
    @Operation(description = "회원 이메일 수정 API")
    @PatchMapping("/emails")
    ...
    // 회원 지역 수정
    @Operation(description = "회원 지역 수정 API")
